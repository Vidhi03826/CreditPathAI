...
All Features Accuracy: 44%

Selected Features Accuracy: 40%

Key Findings:

- Age is the strongest predictor.
- Removing features decreased accuracy.
- Feature interaction plays an important role.
...
* Loan Month contributes no meaningful signal.
